...
const AdminProjects = () => {
  ...
  return (
    <div className="max-w-[1400px] mx-auto p-6 bg-white shadow rounded">
      <h2 className="text-2xl md:text-4xl font-bold mb-6 text-center">Create Project</h2>
        ...
        <div className="flex flex-col md:flex-row w-full">
          <div className="w-full md:w-1/4">
            ...
            <input
              ...
              className="border w-full text-black bg-gray-100 border-gray-300 p-2 rounded cursor-pointer"
            />
            {imagePreview && (
              <img
                src={imagePreview}
                alt="preview"
                className="mt-3 w-full max-h-60 object-cover rounded border text-black bg-gray-100 border-gray-300"
              />
            )}
          </div>
          <div className="w-full md:w-1/4 md:pl-6 mt-4 md:mt-0">
            <label className="block text-lg font-medium text-gray-700 mb-2">
              Status
            </label>
            <select
