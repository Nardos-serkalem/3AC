...
const AdminResearch = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Post to backend (change endpoint if your API differs)
      ...
      setParagraphs([""]);
      console.log("Research created:", res.data);
    } catch (err) {
      console.error(err);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="border w-full md:w-1/4 text-black bg-gray-100 border-gray-300 p-2 rounded cursor-pointer"
          />
          {imagePreview && (
            <img
              src={imagePreview}
        ...
        <div className="pt-4">
          ...
          >
            {submitting ? "Uploading..." : "Create Research"}
          </button>
        </div>
      </form>
    </div>
